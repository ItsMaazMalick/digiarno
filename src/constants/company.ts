...
export const companyNumber: string = "+92 312 5770 904";
export const companyMail: string = "info@digiarno.com";

export const companyAddress: string =
  "Office No.02,1st floor Main Athal Chowk Bharakahu ISB Pakistan";
