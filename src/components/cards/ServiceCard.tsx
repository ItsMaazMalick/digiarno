  ...
  return (
    <div className={cn("w-full", className)}>
      <CardContainer className="inter-var">
        <CardBody className="bg-primary/10 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1]  h-auto rounded-xl p-6 border  ">
